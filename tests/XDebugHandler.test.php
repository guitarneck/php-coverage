...
require_once 'mocks\XDebugMock.php';

// T E S T S ---

test('XDebugHandler - coverage : no filter',function(TAPHP $t)
{
...
test('XDebugHandler - coverage : with filter include',function(TAPHP $t)
{
...
test('XDebugHandler - coverage : with filter exclude',function(TAPHP $t)
{
...
test('XDebugHandler - coverage : purged',function(TAPHP $t){
