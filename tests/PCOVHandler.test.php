...
require_once 'mocks/PCOVMock.php';

// T E S T S ---

test('PCOVHandler - coverage : no filter',function(TAPHP $t){
...
test('PCOVHandler - coverage : with filter include',function(TAPHP $t)
{
...
test('PCOVHandler - coverage : with filter exclude',function(TAPHP $t)
{
...
test('PCOVHandler - coverage : purged',function(TAPHP $t){
